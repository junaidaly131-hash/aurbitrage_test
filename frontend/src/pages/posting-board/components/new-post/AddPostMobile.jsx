...
import CreatePostMobileHeader from "./CreatePostHeader/CreatePostMobileHeader";
import { FormControler } from "./post-settings/style";
import { CheckBox, Icon, Label } from "../PostFilters/style";
  ...
  return (
    <>
      ...
      <StyledModal open={open} onClose={handleClose}>
        ...
        >
          <CreatePostMobileHeader handleBack={handleBack} />
          ...
          <MobileActionButtons>
            <Button
              variant="contained"
              onClick={step === 2 ? onPreviewPostClick : handleNext}
            >
              {step === 0
                ? "Continue"
                : step === 2
